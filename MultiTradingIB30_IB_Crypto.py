...
#    "ABTC": {"symbol": "ABTC", "long": True, "short": True, "initialCapitalLong": 1200, "initialCapitalShort": 1200, "order_round_factor":1},
    "AETH": {"symbol": "AETH", "long": True, "short": True, "initialCapitalLong": 1100, "initialCapitalShort": 1100, "order_round_factor":1},
#    "ETHM24": {"symbol": "ETHM24", "long": True, "short": True, "initialCapitalLong": 1800, "initialCapitalShort": 1800, "order_round_factor":1},
#    "ZETH":  {"symbol": "ZETH",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
#    "XLME": {"symbol": "XLME",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
 #   "AADA": {"symbol": "AADA",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
#    "21XP": {"symbol": "21XP",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
 #   "HODLEUR": {"symbol": "HODLEUR",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
##    "ABTCEUR": {"symbol": "ABTCEUR",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
    "ARKB": {"symbol": "ARKB",  "long": True, "short": True, "initialCapitalLong": 1500,  "initialCapitalShort": 1500, "order_round_factor":1},
 ##   "ASUI": {"symbol": "ASUI",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
#    "21BC": {"symbol": "21BC",  "long": True, "short": True, "initialCapitalLong": 1000,  "initialCapitalShort": 1000, "order_round_factor":1},
    "DOGEEUR": {"symbol": "DOGEEUR", "long": True, "short": True, "initialCapitalLong": 2000,  "initialCapitalShort": 2000, "order_round_factor":10}
}
...
def both_backtesting_multi(ib):
    for ticker, config in tickers.items():
        ...
        if os.path.exists(csv_filename):
            ...
            df = update_historical_data_csv(ib, contract, csv_filename)
            df.rename(columns={"open": "Open", "high": "High", "low": "Low", "close": "Close"}, inplace=True)
        # Beispiel: Minutendaten für den letzten Tag laden und speichern
        ...
        # Bestimme künstlichen Close (letzter Tageskurs)
        # Bestimme künstlichen Close (letzter Tageskurs)
       ...
       # plot_equity_curves_and_stats(
        #    df,
         #   long_trades,
          #  short_trades,
           # ticker,
            #config["initialCapitalLong"],
            #config["initialCapitalShort"]
        #)
        ...
        # Calculate support and resistance for plotting
        best_p_long, best_tw_long = berechne_best_p_tw_long(df, config, backtesting_begin, backtesting_end)
        best_sup_long, best_res_long = calculate_support_resistance(df, best_p_long, best_tw_long)
        best_p_short, best_tw_short = berechne_best_p_tw_short(df, config, backtesting_begin, backtesting_end)
        best_sup_short, best_res_short = calculate_support_resistance(df, best_p_short, best_tw_short)
        ...
        plot_combined_chart_and_equity(
            ...
            standard_long,
            standard_short,
            best_sup_long, best_res_short, compute_trend(df, 20),
